        ...
        <div class="container mb-5">
             <div class="row mt-5 d-flex justify-content-center">
                <div class="col-12 col-md-5">
                    ...
                    <form action="<?= site_url('/animal/registro/nuevo') ?>" method="POST" class="mt-4">
                        <div class="mb-3">
                    ...
                    <div class="d-grid gap-2">
							...
							<a class="btn boton" href="<?= site_url('/animal/listado')?>">Ver Inventario</a>
                        </div>
                        
                    </form>
                </div>
                <div class="col-12 col-md-5 align-self-end">
                    <img src="<?= base_url('public/img/perrocatstile.png')?>" alt="imagen" class="img-fluid w-100">
                </div>
            </div>
        </div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header fondoPrincipal text-white">
							<h5 class="modal-title">Animal House</h5>
