                ...
                <div class="col-12 col-md-5">
                    ...
                    <form action="<?= site_url('/productos/registro/nuevo') ?>" method="POST" class="mt-4">
                        ...
                        <div class="d-grid gap-2">
							...
							<a class="btn boton" href="<?= site_url('/productos/listado')?>">Ver Inventario</a>
                        </div>
                        
                    </form>
                </div>
                <div class="col-12 col-md-5 align-self-end text-center d-grid gap-2">
                    <img src="<?= base_url('public/img/img1.png')?>" alt="imagen" class="img-fluid w-100">
